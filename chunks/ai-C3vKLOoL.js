const e="Puedes usar etiquetas HTML básicas como <b>, <i> o <br> para dar formato a la respuesta.",n={task:{model:"gemini-2.5-flash-preview-05-20",prompt:`Asistente Inteligente de Productividad y Gestión de Estado de Ánimo
...
### **{ESTILO DE COMUNICACIÓN}**
Explica de forma práctica y directa, como un consultor que entiende las limitaciones reales del trabajo desde casa. Justifica cada sugerencia con el beneficio específico que tendrá. No propongas hábitos genéricos: personalízalos para el contexto de Alexander. Enfócate en la implementación práctica, no solo en los beneficios.`+e}},negativeHabit:{model:"gemini-2.5-flash-preview-05-20",prompts:{impact:`### **{ROL}**
